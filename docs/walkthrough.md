...
- Khởi chạy song song 5 tiến trình độc lập (Site A, Site B, Site C, Site D và Hacker Proxy).
...
- Tính chính xác (Accuracy): Cả hai kịch bản chạy thử nghiệm đều cho ra kết quả tổng lương chính xác tuyệt đối là 580,000 (đúng bằng tổng giá trị lưu trữ riêng tư tại 4 phòng ban: 120,000 + 150,000 + 180,000 + 130,000). Sai số thực nghiệm bằng 0.
- Tính bảo mật (Security): Trong kịch bản có nghe lén, hacker chỉ bắt được dữ liệu thô chuyển đi là 187,707. Do không nắm giữ số ngẫu nhiên R = 67,707, hacker không có cách nào giải phương trình để suy ra mức lương thực tế của phòng ban IT (120,000). Quyền riêng tư của đơn vị khởi tạo được bảo vệ an toàn.
