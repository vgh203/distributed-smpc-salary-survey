...
- /local-summary: Trả về tổng lương cục bộ và danh sách nhân viên qua API thay vì đọc file trực tiếp.
...
Expose các endpoint:
- /local-summary: Hỗ trợ tính toán và cung cấp dữ liệu phục vụ audit/verification và traditional benchmark.
...
[Site-A] Global Average: 145000 (Calculated using 4 sites)
...
[Site-A] Global Average: 394999.75 (Calculated using 4 sites)
```
